"""
Answer Relevance Classifier Component for Langflow

Classify whether an answer is relevant to the question.
"""
...
class AnswerRelevanceClassifier(Component):
    display_name = "Answer Relevance Classifier"
    description = "Classify whether an answer is relevant to the question"
    category = "tools"
    icon = "message-square"
