"""
Answer Relevance Rewriter Component for Langflow

Rewrite an answer to be more relevant to the question.
"""
...
class AnswerRelevanceRewriter(Component):
    display_name = "Answer Relevance Rewriter"
    description = "Rewrite an answer to be more relevant to the question"
    category = "tools"
    icon = "message-square"
